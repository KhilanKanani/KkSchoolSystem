            ...
            <table class="min-w-full text-left font-light">
                <thead class="border-b border-lime-300 bg-lime-100">
                    <tr>
                        ...
                        <th class="px-4 border border-gray-300 py-3 text-center w-24">Delete</th>
                        <th class="px-4 border border-gray-300 py-3 text-center w-24">Update</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr class="border-b hover:bg-lime-50 transition">
                            ...
                            <td class="px-4 py-3 border border-gray-300 font-semibold text-lime-800"><?php echo htmlspecialchars($row['name']); ?>
                            </td>
                            ...
                            <td class="px-4 py-3 border border-gray-300 text-center">
                                <a href="DeleteCourse.php?id=<?php echo $row['id']; ?>"
                                    ...
                                    class="inline-block bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-md text-sm font-semibold transition select-none">
                                    Delete
                                </a>
                            </td>
                            <td class="px-4 py-3 border border-gray-300 text-center">
                                <a href="AddCourseAdmin.php?id=<?php echo $row['id']; ?>"
                                    class="inline-block bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-md text-sm font-semibold transition select-none">
                                    Update
                                </a>
                            </td>
                        </tr>
            ...
            <?php while ($row = mysqli_fetch_assoc($result)): ?>
                <div class="bg-white rounded-lg shadow-md p-4 flex flex-col gap-3 border border-lime-300">
                    ...
                    <div class="flex gap-3 mt-2">
                        <a href="DeleteCourse.php?id=<?php echo $row['id']; ?>"
                            onclick="return confirm('Are you sure you want to delete this course?');"
                            class="flex-1 bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-md text-center text-sm font-semibold select-none transition">
                            Delete
                        </a>
                        <a href="AddCourseAdmin.php?id=<?php echo $row['id']; ?>"
                            class="flex-1 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-md text-center text-sm font-semibold select-none transition">
                            Update
                        </a>
                    </div>
                </div>
